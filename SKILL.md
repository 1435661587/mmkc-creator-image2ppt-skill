---
name: mmkc-creator-image2ppt-skill
description: >
  把图片、截图、HTML 或 SVG 设计稿重建为可编辑 PPTX，支持文本框、原生形状和组件化版式还原。
  English: Rebuild images, screenshots, HTML, or SVG designs into editable PPTX files with text boxes, native shapes, and component-style layout recovery.
---

# MMKC Creator Image2PPT
...
```bash
python3 mmkc-creator-image2ppt-skill/scripts/init_project.py pitch_deck \
...
6. 运行：
   ...
   python3 mmkc-creator-image2ppt-skill/scripts/image2pptx.py build \
     --manifest mmkc-creator-image2ppt-skill/projects/YYYYMMDD_slug/manifest.json \
     --output mmkc-creator-image2ppt-skill/projects/YYYYMMDD_slug/output.pptx \
     --summary mmkc-creator-image2ppt-skill/projects/YYYYMMDD_slug/summary.json
   ```
...
python3 mmkc-creator-image2ppt-skill/scripts/html_svg_to_manifest.py input.svg \
  --output mmkc-creator-image2ppt-skill/projects/YYYYMMDD_slug/manifest.json
