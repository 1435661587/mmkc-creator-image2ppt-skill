#!/usr/bin/env python3
"""Build editable PPTX files from a mmkc-creator-image2ppt-skill manifest."""
...
def build_pptx(manifest_path: Path, output_path: Path | None = None, summary_path: Path | None = None) -> dict[str, Any]:
    ...
    props.subject = "Generated by mmkc-creator-image2ppt-skill"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build editable PPTX from a mmkc-creator-image2ppt-skill manifest.",
