#!/usr/bin/env python3
"""Convert simple HTML/SVG slide-like files into a mmkc-creator-image2ppt-skill manifest."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Convert simple HTML/SVG files to a mmkc-creator-image2ppt-skill manifest.",
