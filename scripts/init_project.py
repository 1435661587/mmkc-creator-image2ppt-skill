#!/usr/bin/env python3
"""Create a mmkc-creator-image2ppt-skill project folder for one conversion run."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Initialize a project folder under mmkc-creator-image2ppt-skill/projects.",
